...
//styles
import styles from"./BeauticianINF.module.css"

//components 
import CommentingPart from '../../helper/Commenting/CommentingPart';

//images
import BG from '../../assets/women-services/mainBG00.jpg'
...
const BarberINF = () => {
    const INFs=useContext(BeauticianContext)
    ...
    let shown_services = uniqueServices.join(` And `);
